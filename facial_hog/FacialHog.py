"""
    ...
    Data: 21/05/2019
    Descricao: Classe responsavel por fazer a deteccao da face 
"""
import dlib
import numpy as np
...
class FacialHog():
    ...
    def __init__(self):
        ...
        self.detector_pontos = dlib.shape_predictor("facial_hog/recursos/shape_predictor_68_face_landmarks.dat")
        self.reconhecimento_facial = dlib.face_recognition_model_v1("facial_hog/recursos/dlib_face_recognition_resnet_model_v1.dat")
        self.indice = {}
        self.idx = 0
        self.descritores_faciais = None


    def detecta_face(self, frame=None, shape=1, label = None):


        if not frame is None:

            faces_detectadas = self.detector_face(frame, shape)
            ...
            print("imagem ou shape não passado como parametro")
            return None
