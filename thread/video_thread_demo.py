...
video_stream = VideoStream("rtsp://admin:felix333235@192.168.2.50:1025/Streaming/Channels/101/").start()
#video_stream1 = VideoStream("rtsp://admin:felix5803001234@10.35.27.9:554/h264/ch1/main/av_stream").start()
